...
copy ..\RdlDesign\bin\x64\Release\ScintillaNET.dll .\build-output\majorsilence-reporting-build-dot-net-4-x64\ScintillaNET.dll /Y
...
copy ..\RdlDesign\bin\x64\Release\EncryptionProvider.dll .\build-output\majorsilence-reporting-build-dot-net-4-x64\EncryptionProvider.dll /Y
...
copy ..\RdlDesign\bin\x86\Release\ScintillaNET.dll .\build-output\majorsilence-reporting-build-dot-net-4-x86\ScintillaNET.dll /Y
...
copy ..\RdlDesign\bin\x86\Release\EncryptionProvider.dll .\build-output\majorsilence-reporting-build-dot-net-4-x86\EncryptionProvider.dll /Y
